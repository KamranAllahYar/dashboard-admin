    ...
    <n-space>
      ...
      >
        <n-space vertical style="gap: 0px">
          ...
          <p class="text_font_color" style="font-size: 20px">Disputes</p>
        </n-space>
      </n-card>
      <n-card
        style="
      ...
      >
        <n-space vertical style="gap: 0px">
          ...
          <p class="text_font_color" style="font-size: 20px">Updated By WeShip</p>
        </n-space>
      </n-card>
      <n-card
        style="
      ...
      >
        <n-space vertical style="gap: 0px">
          <p class="text_font_color">0</p>
          <p class="text_font_color" style="font-size: 20px">New Updates</p>
          <p style="color: rgb(38, 63, 151); opacity: 0.6; font-size: 12px">
            Disputes updated in last 24 hours
          </p>
        </n-space>
      </n-card>
      <n-card
      ...
      >
        <n-space vertical style="gap: 0px">
          ...
          <p style="color: rgb(38, 63, 151); opacity: 0.6; font-size: 12px">
            Disputes expires in next 24 hours
          </p>
        </n-space>
      </n-card>
    </n-space>
...
<script lang="ts" setup>
  ...
  const dispute_date: DataTableColumn<InternalRowData> = {
    key: 'date',
    align: 'center',
