      ...
      <n-grid v-else :x-gap="6" cols="2 l:2" responsive="screen">
        <n-grid-item :span="1">
          <n-steps :vertical="true" :current="currentRef" status="process">
                    ...
                    <n-space :vertical="true">
                      ...
                      >
                        <n-input
                          ...
                          placeholder="eg: https//fredefy.myClicky.com/admin"
                        />
                      </n-form-item>
                    </n-space>
                    <!--                    <p-->
            ...
            <!--                        </svg>-->
            <!--                      </n-icon>-->
            <!--                      &lt;!&ndash;                      <n-button> Duck </n-button>&ndash;&gt;-->
            <!--                    </template>-->
            <!--                    Copy-->
            <!--                  </n-tooltip>-->
            <!--                </n-space>-->
            ...
            <n-step>
              <n-space :vertical="true">
                <p
                  ...
                  "
                >
                  Once Clicky Website Admin url entered, click on connect with Clicky button below.
                </p>
                <n-button
                  :round="true"
                  type="info"
                  @click="connectWithClicky"
                  style="
                    margin-left: 20px;
                    font-weight: bold;
                    font-size: 14px;
              ...
              <div style="display: flex; flex-direction: row; margin-top: 10px">
                ...
                <p
                  style="
                    ...
                    padding-bottom: 8px;
                  "
                  >Enter website admin url of Clicky store and click on Download Weship App.</p
                >
              </div>
              <div style="display: flex; flex-direction: row">
                ...
                <p
                  style="
                    ...
                    padding-bottom: 8px;
                  "
                  >You’ll be re-directed to Login Clicky admin panel. On successful login, you’ll
              ...
              <div style="display: flex; flex-direction: row">
                ...
                <p
                  style="
                    ...
                    padding-bottom: 8px;
                  "
                  >Once Weship app is configured on Clicky, come back to Weship and click on Connect
                  with Clicky button. System will automatically fetch authentication token from
                  Clicky.
                </p>
              </div>
              <div style="display: flex; flex-direction: row">
          ...
          >
            ...
            <n-form-item :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the initial status of Clicky Orders on to sync in Weship"
              />
            </n-form-item>
            <p
              style="
            ...
            <p
              ...
              "
            >
              Update Clicky status codes against provided Weship Tracking Statuses
            </p>
            <p
              style="
                font-weight: bold;
            ...
            <n-form-item path="order_placed" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is placed in Weship"
              />
            </n-form-item>
            <p
              style="
            ...
            <n-form-item path="in_transit" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is in transit to customers"
              />
            </n-form-item>
            <p
              style="
            ...
            <n-form-item path="rtd" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is RTD to end customer"
              />
            </n-form-item>
            <p
              style="
            ...
            <n-form-item path="rto" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is RTO to end customer"
              />
            </n-form-item>
          </n-form>
        </n-grid-item>
          ...
          >
            ...
            <n-form-item path="picked_up" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is picked to end customer"
              />
            </n-form-item>
            <p
              style="
            ...
            <n-form-item path="delivered" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is delivered to end customer"
              />
            </n-form-item>
            <p
              style="
            ...
            <n-form-item path="delivered" :show-label="false" style="margin-bottom: 0px">
              <n-input
                ...
                placeholder="Enter the exact status on Clicky when order is cancelled to end customer"
              />
            </n-form-item>
          </n-form>
        </n-grid-item>
...
<script lang="ts" setup>
  ...
  const rules = {
    website_url: {
      ...
      validator(rule: FormItemRule, value: string) {
        if (!value) {
          return new Error('Clicky website admin url is required');
        } else if (
  ...
  function saveData() {
    if (isChannelConnected.value) {
      ...
      window['$message'].error('Please Connect with Clicky first');
    }
  }
</script>
<style scoped></style>
