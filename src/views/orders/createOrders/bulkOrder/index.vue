...
<script lang="ts" setup>
  ...
  import { uploadCSVBulkOrders } from '@/api/order';
  ...
  function downloadSampleFile() {
    window.open(
      'https://s3.me-south-1.amazonaws.com/clickycrmdev/weship/bulk-orders/2023/2023-04-28/1682687760513-test-data.csv'
    );
  }
</script>
