  ...
  <n-card>
    <n-space vertical>
      <n-space justify="space-between">
        <span></span>
        <n-button strong type="success" @click="showCreateNewZoneModal"> Create New Zone </n-button>
      </n-space>
      ...
      <n-modal style="width: 50%" v-model:show="showCreateZoneModal" preset="dialog">
        <template #header>
          <div>Create New Zone</div>
        </template>
...
<script lang="ts" setup>
  ...
  import { deleteZone, getZonesList } from '@/api/courier';

  const zones = ref();
  const showCreateZoneModal = ref();
  ...
  function showCreateNewZoneModal() {
